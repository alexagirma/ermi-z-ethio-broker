      ...
      <Box>
        {!nextPage ? (
          ...
          >
            ...
            >
              <TextField label="City" size="small" required fullWidth />
            </Box>
            ...
            >
              <TextField label="State" size="small" required fullWidth />
            </Box>
            ...
            >
              <TextField label="Bedrooms" type="number" size="small" required fullWidth />
            </Box>
            ...
            >
              <TextField label="Bathrooms" type="number" size="small" required fullWidth />
            </Box>
